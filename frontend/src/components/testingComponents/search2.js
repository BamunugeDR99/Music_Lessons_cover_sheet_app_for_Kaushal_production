...
let k = [];
  ...
  let getSuggestions = () => {
    ...
    if (suggest.length === 0 && searchtext !== "" && !resfound) {
      return <p style={{height:'30px',paddingTop:'3px'}}>&ensp;Search Content Not Found</p>;
    }
    ...
    console.log(k),
        ...
        <ul style={{overflowY: 'scroll', height:'20%', overflowY:'hidden',listStyle:'none'}}>
          {/* <select> */}
          {k.map((item, index) => {
            ...
            return (
              <div key={index}>
                ...
                <li style={{height:'30px',paddingTop:'3px'}} onClick={() => suggestedText(item)}>&ensp;{item}</li>
    ...
    <div className="MainSearchBar">
      <div class="wrapper ">
        <div class="search-input" id="searchInput">
          ...
          <input type="text" placeholder="Type to search.." value={searchtext} onChange={handleChange} style={{color:'#000000'}}/>
            {/* <li style={{listStyleType: 'none',
              overflow:'auto',overflowY: 'scroll', height:'20%', overflowY:'200px'
              }}> */}
              {getSuggestions()}
              {/* </li> */}
