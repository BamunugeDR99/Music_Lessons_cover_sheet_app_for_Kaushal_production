...
const specialCharacterRegx = /[ !@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?]/;
  ...
  function validate(){
    ...
    flag1 = 0;
    SetContactNoError('Enter only numeric values to phone number')
  
   
    
  } else if (ContactNumber.length > 10) {
    flag1 = 0;
   SetContactNoError('Phone Number must be 10 digit number')
  ...
  flag1 = 0;
  SetPasswordError('Password must contain minimum 8 chracters')
  ...
  flag1 = 0;
  SetPasswordError('Password must contain at least one lowercase letter, one uppercase letter, one numeric digit') 
  ...
  flag1 = 0;
  setTnCError('You must agree with our terms & conditions')
...
function checkNamePattern(){
  ...
  console.log(FirstName.match(namePattern));
                      ...
                      <div class="input-group">
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            ...
                            SetUsernameError("GG is error and error GG is error and error");
                            // validateUserName();
                          }}
                        />
                      </div>
                      <p  className="ml-5" style={{color:"red", fontWeight:"bold"}}>{UsernameError}</p>
                    </div>
                  </div>
                </div>
                {/* email */}
                    ...
                    <div class="text-center">
                      <div class="container-fluid">
                        <div class="form-group row">
                          ...
                          <p  style={{color:"red", fontWeight:"bold"}}>{FirstNameError}</p>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="text-center">
                      <div class="container-fluid">
                        <div class="form-group row">
                          ...
                          <p className="ml-5 mt-1 mb-0" style={{color:"red", fontWeight:"bold"}}>{LastNameError}</p>
                        </div>
                      </div>
                    </div>
                  </div>
